...
public class GradientTextureView extends TextureView implements Renderer {
    ...
    public GradientTextureView(@NonNull Context context) { super(context); init(context); }
    public GradientTextureView(@NonNull Context context, @Nullable AttributeSet attrs) { super(context, attrs); init(context); }
    public GradientTextureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) { super(context, attrs, defStyleAttr); init(context); }
    public GradientTextureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) { super(context, attrs, defStyleAttr, defStyleRes); init(context); }
    ...
    public void setGeneratedBitmap(Bitmap bitmap) {
        if (renderThread != null) {
            renderThread.queueEvent(() -> renderThread.setGeneratedBitmap(bitmap));
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (renderThread != null) {
            renderThread.queueEvent(() -> renderThread.onTouchEvent(event));
        }
        return true;
    }
