package cn.nubia.aigeneration.libgemini;
...
public class GradientTextureView extends TextureView {
    ...
    private static class GLRenderThread extends Thread {
        ...
        // 【核心修复点】：构造函数接收初始暂停状态
        public GLRenderThread(SurfaceTexture surfaceTexture, GLSurfaceView.Renderer renderer,
                              int width, int height, boolean startImmediately) {
